...
## Upgrading from Spark SQL 2.4 to 3.0
  ...
  - Since Spark 3.0, grouping_id() returns long values. In Spark version 2.4 and earlier, this function returns int values. To restore the behavior before Spark 3.0, you can set `spark.sql.legacy.integerGroupingId.enabled` to `true`.
