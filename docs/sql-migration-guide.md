...
## Upgrading from Spark SQL 2.4 to 3.0
  ...
  - Since Spark 3.0, XXXX. In Spark version 2.4 and earlier, XXXX. To restore the behavior before Spark 3.0, you can set `spark.sql.legacy.integerGroupingId.enabled` to `true`.
