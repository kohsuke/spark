...
class GroupedMapInPandasTests(ReusedSQLTestCase):
    ...
    def test_supported_types(self):
        ...
        assert_frame_equal(expected2, result2, check_column_type=True)
        assert_frame_equal(expected3, result3, check_column_type=True)
    ...
    def test_array_type_correct(self):
        ...
        assert_frame_equal(expected, result, check_column_type=True)
    ...
    def test_timestamp_dst(self):
        ...
        assert_frame_equal(df.toPandas(), result.toPandas(), check_column_type=True)
    ...
    def test_udf_with_key(self):
        ...
        assert_frame_equal(expected4, result4, check_column_type=True)
