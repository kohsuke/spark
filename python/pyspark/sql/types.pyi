...
from typing import Any, Callable, Dict, Iterator, List, NoReturn, Optional, Union, Tuple, TypeVar
import datetime
...
class CalendarIntervalType(DataType, metaclass=DataTypeSingleton):
    ...
    def needConversion(self) -> bool: ...
    def simpleString(self) -> str: ...
    def toInternal(self, di: Any) -> NoReturn: ...
    def fromInternal(self, v: Dict[str, Any]) -> NoReturn: ...
