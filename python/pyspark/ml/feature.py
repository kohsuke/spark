...
class _QuantileTransformParams(HasInputCol, HasOutputCol, HasRelativeError):
    ...
    @since("3.0.0")
    def getSkipZero(self):
        """
        Gets the value of skipZero or its default value.
        """
        return self.getOrDefault(self.skipZero)
...
class QuantileTransform(JavaEstimator, _QuantileTransformParams, JavaMLReadable, JavaMLWritable):
    ...
    @keyword_only
    def __init__(self, numQuantiles=1000, distribution="uniform", skipZero=False,
                 inputCol=None, outputCol=None, relativeError=0.001):
        """
        __init__(self, numQuantiles=1000, distribution="uniform", skipZero=False, \
                 inputCol=None, outputCol=None, relativeError=0.001)
        """
        super(QuantileTransform, self).__init__()
        self._java_obj = self._new_java_obj("org.apache.spark.ml.feature.QuantileTransform",
                                            self.uid)
        self._setDefault(numQuantiles=1000, distribution="uniform", skipZero=False,
                         relativeError=0.001)
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
    ...
    @keyword_only
    @since("3.0.0")
    def setParams(self, numQuantiles=1000, distribution="uniform", skipZero=False,
                  inputCol=None, outputCol=None, relativeError=0.001):
        """
        setParams(self, numQuantiles=1000, distribution="uniform", skipZero=False, \
                  inputCol=None, outputCol=None, relativeError=0.001)
    ...
    @since("3.0.0")
    def setSkipZero(self, value):
        """
        Sets the value of :py:attr:`skipZero`.
        """
        return self._set(skipZero=value)
