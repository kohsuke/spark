...
select TIMESTAMP_MILLISECONDS(1230219000123),TIMESTAMP_MILLISECONDS(-1230219000123),TIMESTAMP_MILLISECONDS(null);
select TIMESTAMP_MICROSECONDS(1230219000123123),TIMESTAMP_MICROSECONDS(-1230219000123123),TIMESTAMP_MICROSECONDS(null);
-- overflow exception:
select TIMESTAMP_SECONDS(1230219000123123),TIMESTAMP_SECONDS(-1230219000123123),TIMESTAMP_SECONDS(null);
select TIMESTAMP_MILLISECONDS(92233720368547758),TIMESTAMP_MILLISECONDS(-92233720368547758),TIMESTAMP_MILLISECONDS(null);
