...
import org.apache.spark.sql.catalog.v2.{CatalogExtension, Identifier, TableCatalog}
 ...
 * and SQL).
 */
private[v2] abstract class TestV2SessionCatalogBase[T <: Table](delegate: TableCatalog)
  extends CatalogExtension(delegate) {
