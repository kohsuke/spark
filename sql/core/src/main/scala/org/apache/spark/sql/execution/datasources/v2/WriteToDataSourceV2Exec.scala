...
case class CreateTableAsSelectExec(
  ...
  override protected def doExecute(): RDD[InternalRow] = {
    ...
    Utils.tryWithSafeFinallyAndFailureCallbacks({
      ...
      val table = catalog.createTable(ident, schema, partitioning.toArray, properties.asJava)
      val writeBuilder = V2WriteStrategy.newWriteBuilder(table, writeOptions, schema)
