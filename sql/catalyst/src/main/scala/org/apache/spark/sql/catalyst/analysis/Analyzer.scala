...
class Analyzer(
  ...
  def this(catalog: SessionCatalog, conf: SQLConf) = {
    this(catalog, new CatalogManager(conf, FakeV2SessionCatalog), conf, conf.optimizerMaxIterations)
  }

  def this(catalog: SessionCatalog, catalogManager: CatalogManager, conf: SQLConf) = {
    this(catalog, catalogManager, conf, conf.optimizerMaxIterations)
  }
