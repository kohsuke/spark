...
case class AlterTableAddColumnsStatement(
    ...
    columnsToAdd: Seq[QualifiedColType]) extends StatementRequiringTable
...
case class AlterTableAlterColumnStatement(
    ...
    comment: Option[String]) extends StatementRequiringTable
...
case class AlterTableRenameColumnStatement(
    tableName: Seq[String],
    column: Seq[String],
    newName: String) extends StatementRequiringTable
...
case class AlterTableDropColumnsStatement(
    tableName: Seq[String],
    columnsToDrop: Seq[Seq[String]]) extends StatementRequiringTable
...
case class AlterTableSetPropertiesStatement(
    tableName: Seq[String],
    properties: Map[String, String]) extends StatementRequiringTable
...
case class AlterTableUnsetPropertiesStatement(
    ...
    ifExists: Boolean) extends StatementRequiringTable
...
case class AlterTableSetLocationStatement(
    tableName: Seq[String],
    location: String) extends StatementRequiringTable
