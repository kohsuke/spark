...
object SQLConf {
  ...
  val LEGACY_ALLOW_LEADING_INTERVAL_STRING_IN_CAST =
    buildConf("spark.sql.legacy.allowLeadingIntervalStringInCast")
      .doc("When true, it's allowed to have the leading 'interval' in the string that is being " +
