 ...
 * and add hooks to apply some custom logic. For example, they can override {@code createTable},
 * and call {@code super.createTable} with empty schema and partition, to avoid duplicating table
 * metadata in the Spark built-in session catalog.
 */
