        ...
        $.getJSON(endPoint, function (response, status, jqXHR) {
            ...
            $.get(createTemplateURI(appId, "executorspage"), function (template) {
                ...
                $("#showAdditionalMetrics").append(
                    ...
                    "<div id='jvm_on_off_heap_memory' class='jvm_on_off_heap_memory-checkbox-div'><input type='checkbox' class='toggle-vis' data-sum-col-idx='' data-exec-col-idx='7' > JVM Memory OnHeap / OffHeap</div>" +
                    "<div id='on_off_heap_execution_memory' class='on_off_heap_execution_memory-checkbox-div'><input type='checkbox' class='toggle-vis' data-sum-col-idx='' data-exec-col-idx='8'> Execution Memory OnHeap / OffHeap</div>" +
                    "<div id='on_off_heap_storage_memory' class='on_off_heap_storage_memory'><input type='checkbox' class='toggle-vis' data-sum-col-idx='' data-exec-col-idx='9'> Storage Memory OnHeap / OffHeap</div>" +
                    "<div id='direct_mapped_pool_memory' class='direct_mapped_pool_memory-checkbox-div'><input type='checkbox' class='toggle-vis' data-sum-col-idx='' data-exec-col-idx='10'> Pool Memory Direct / Mapped</div>" +
