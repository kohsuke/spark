...
public final class UnsafeSorterSpillReader extends UnsafeSorterIterator implements Closeable {
  ...
  private final int bufferMultiplicationRatio = SparkEnv.get() == null ? DEFAULT_BUFFER_SIZE_RATIO:
      (int)SparkEnv.get().conf().get(package$.MODULE$.UNSAFE_SORTER_SPILL_READER_BUFFER_SIZE_RATIO());
  ...
  private byte[] arr = new byte[1024 * bufferMultiplicationRatio];
