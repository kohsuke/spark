...
class TaskMetrics private[spark] () extends Serializable {
  ...
  @transient private[spark] lazy val nameToAccums = LinkedHashMap(
    ...
    shuffleRead.HOST_LOCAL_BLOCKS_FETCHED -> shuffleReadMetrics._hostLocalBlocksFetched,
    ...
    shuffleRead.HOST_LOCAL_BYTES_READ -> shuffleReadMetrics._hostLocalBytesRead,
